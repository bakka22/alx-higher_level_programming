...
class TBase(unittest.TestCase):
    ...
    def nb_objects_private(self):
        '''Testtribute.'''
        self.assertTrue(hasattr(Base, "_Base__nb_objects"))

    def te_nb_objects_initialized(self):
        '''Tests if to zero.'''
        self.assertEqual(getattr(Base, "_Base__nb_objects"), 0)

    def tenstantiation(self):
        '''Teinstantiation.'''
        b = Base()
    ...
    def test_Dor_args_2(self):
        '''Tests coe with 2 notself args.'''
        with self.assertRaises(TypeError) as e:
...
were given"
    ...
    def tsynced(self):
        '''Testsass and instance id.'''
        b = Base()
        self.assertEqual(getattr(Base, "_Base__nb_objects"), b.id)

    def test_F_more(self):
        '''T class and instance id.'''
        b = Base()
        b = Base("Foo")
        b = Base(98)
        b = Base()
    ...
    def test_G_cum_id_int(self):
        '''Tests c int id.'''
        i = 98
        b = Base(i)
        self.assertEqual(b.id, i)

    def teststom_id_str(self):
        '''Test int id.'''
        i = "FooBar"
        b = Base(i)
        self.assertEqual(b.id, i)

    def test_Gkeyword(self):
        '''Tests idkeyword arg.'''
        i = 421
        b = Base(id=i)
        self.assertEqual(b.id, i)
